...
data T_Literal_124
  = C_nat_128 Integer
  | C_word64_132 MAlonzo.RTE.Word64
...
d_Term_154 = ()
data T_Term_154
  = C_var_172 Integer [T_Arg_88]
  | C_con_178 AgdaAny [T_Arg_88]
  | C_def_184 AgdaAny [T_Arg_88]
  | C_lam_190 T_Visibility_48 T_Abs_112
  | C_pat'45'lam_196 [T_Clause_160] [T_Arg_88]
  | C_pi_202 T_Arg_88 T_Abs_112
  | C_agda'45'sort_206 T_Sort_156
  | C_lit_210 T_Literal_124
  | C_meta_214 AgdaAny [T_Arg_88]
  | C_unknown_216

-- Agda.Builtin.Reflection.Sort
d_Sort_156 = ()
data T_Sort_156
  = C_set_220 T_Term_154
  | C_lit_224 Integer
  | C_prop_228 T_Term_154
  | C_propLit_232 Integer
  | C_inf_236 Integer
  | C_unknown_238
...
d_Pattern_158 = ()
data T_Pattern_158
  = C_con_244 AgdaAny [T_Arg_88]
  | C_dot_248 T_Term_154
  | C_var_252 Integer
  | C_lit_256 T_Literal_124
  | C_proj_260 AgdaAny
...
data T_ErrorPart_306
  ...
  | C_termErr_310 T_Term_154
  | C_pattErr_312 T_Pattern_158
...
d__'8712'__502 v0 v1 =
  case coe v1 of
    ...
    (:) v2 v3 ->
      let v4 = coe d_primQNameEquality_8 v0 v2
       in coe
...
d__'8713'__528 v0 v1 =
  let v2 = d__'8712'__502 (coe v0) (coe v1)
   in coe
        ( if coe v2
            ...
            if coe v4
              then
                coe
                  ...
                  ( coe
                      d_filter_476
                      (coe (\v6 -> d__'8712'__502 (coe v6) (coe v3)))
                      (coe v5)
                  )
              else
                coe
                  ...
                  ( coe
                      d_filter_476
                      (coe (\v6 -> d__'8713'__528 (coe v6) (coe v5)))
                      (coe v3)
                  )
          _ -> MAlonzo.RTE.mazUnreachableError
        else
                ...
                if coe v4
                  then
                    coe
                      ...
                      ( coe
                          d_filter_476
                          (coe (\v6 -> d__'8713'__528 (coe v6) (coe v3)))
                          (coe v5)
                      )
                  else
                    coe
