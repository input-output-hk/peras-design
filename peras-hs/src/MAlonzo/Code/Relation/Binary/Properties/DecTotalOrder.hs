...
du_'8814''8658''8805'_238 v0 v1 v2 v3 =
  coe
    ...
    ( let v4 =
            coe
              MAlonzo.Code.Relation.Binary.Bundles.du_decPoset_996
              (coe v0)
       in coe
            ( let v5 =
                    coe
                      MAlonzo.Code.Relation.Binary.Bundles.du_decSetoid_520
                      (coe v4)
               in coe
                    ( let v6 =
                            coe
    ...
    ( let v4 =
       ...
       in coe
            ( let v5 =
                    coe MAlonzo.Code.Relation.Binary.Bundles.du_poset_796 (coe v4)
               in coe
                    ( coe
                        MAlonzo.Code.Relation.Binary.Structures.d_reflexive_82
                        ( coe
