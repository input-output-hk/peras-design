...
du_ε'8315''185''8776'ε_270 v0 =
  coe
    ...
    ( coe
        MAlonzo.Code.Algebra.Bundles.d__'8315''185'_1292
        v0
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    ...
                    ( let v1 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v0)
                       in coe
                            ( let v2 =
        ...
        ( coe
            MAlonzo.Code.Algebra.Bundles.d__'8729'__1288
            v0
            ( coe
                MAlonzo.Code.Algebra.Bundles.d__'8315''185'_1292
                v0
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
                    ( let v3 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v0)
                       in coe
                            ( let v4 =
                                    MAlonzo.Code.Algebra.Structures.d_isMonoid_906 (coe v3)
                               in coe
                                    ( let v5 =
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
                    ( let v5 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v0)
                       in coe
                            ( let v6 =
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
                    ( let v2 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v0)
                       in coe
                            ( let v3 =
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    ...
                    ( coe
                        MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
                        ( let v4 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v0)
                           in coe
                                ( let v5 =
  ...
  coe
    ...
    ( coe
        ...
        ( coe
            ...
            v2
            (coe du_'8315''185''45'involutive_316 (coe v0) (coe v2))
        )
    )
