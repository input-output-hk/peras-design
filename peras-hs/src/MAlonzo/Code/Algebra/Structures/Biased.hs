...
du__'45'__228 v0 v1 =
  coe
    MAlonzo.Code.Algebra.Structures.du__'45'__948
    (coe v0)
    (coe v1)
...
du_identity'691'_236 v0 =
  let v1 =
        MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v0)
   in coe
        ( coe
  ...
  let v1 =
   ...
   in coe
        ( let v2 =
           ...
           in coe
                ( let v3 =
                        MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v2)
                   in coe
...
du_isPartialEquivalence_1498 v0 =
  let v1 =
        MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v0)
   in coe
        ( let v2 = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                    ( coe
...
data T_IsCommutativeMonoid'737'_2532
  = C_IsCommutativeMonoid'737''46'constructor_33471
  ...
  coe
    ...
    ( coe
        ...
        ( coe
            ...
            ( let v3 = d_isSemigroup_2544 (coe v2)
               in coe
                    ( coe
                        MAlonzo.Code.Algebra.Structures.du_setoid_168
                        (coe MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v3))
...
data T_IsCommutativeMonoid'691'_2586
  = C_IsCommutativeMonoid'691''46'constructor_34907
      MAlonzo.Code.Algebra.Structures.T_IsSemigroup_440
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny)
  ...
  coe
    ...
    ( coe
        ...
        ( coe
            ...
            ( let v3 = d_isSemigroup_2598 (coe v2)
               in coe
                    ( coe
                        MAlonzo.Code.Algebra.Structures.du_setoid_168
                        (coe MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v3))
...
data T_IsSemiringWithoutOne'42'_2642
  = C_IsSemiringWithoutOne'42''46'constructor_36381
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      MAlonzo.Code.Algebra.Structures.T_IsSemigroup_440
...
du_isNearSemiring_2728 v0 =
  coe
    ...
    (coe d_distrib'691'_2724 (coe v0))
    (coe d_zero'737'_2726 (coe v0))

-- Algebra.Structures.Biased.IsSemiringWithoutAnnihilatingZero*
d_IsSemiringWithoutAnnihilatingZero'42'_2768
  a0
  a1
  a2
  a3
...
data T_IsSemiringWithoutAnnihilatingZero'42'_2768
  = C_IsSemiringWithoutAnnihilatingZero'42''46'constructor_39979
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      MAlonzo.Code.Algebra.Structures.T_IsMonoid_604
      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
du_isPartialEquivalence_2810 v0 =
  let v1 = d_'42''45'isMonoid_2786 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v1)
           in coe
                ( let v3 = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v2)
                   in coe
                        ( coe
                            MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                            ( coe
...
data T_IsCommutativeSemiring'737'_2840
  = C_IsCommutativeSemiring'737''46'constructor_42261
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( let v4 = d_'43''45'isCommutativeMonoid_2858 (coe v3)
                   in coe
                        ( let v5 =
                                MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v4)
                           in coe
                                ( let v6 =
                                        MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v5)
                                   in coe
                                        ( coe
                                            MAlonzo.Code.Algebra.Structures.du_setoid_168
...
data T_IsCommutativeSemiring'691'_2968
  = C_IsCommutativeSemiring'691''46'constructor_47309
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      MAlonzo.Code.Algebra.Structures.T_IsCommutativeMonoid_654
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
    ...
    ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( let v4 = d_'43''45'isCommutativeMonoid_2986 (coe v3)
                   in coe
                        ( let v5 =
                                MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v4)
                           in coe
...
data T_IsRing'42'_3098
  = C_IsRing'42''46'constructor_52421
      MAlonzo.Code.Algebra.Structures.T_IsAbelianGroup_980
      MAlonzo.Code.Algebra.Structures.T_IsMonoid_604
      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
du_isPartialEquivalence_3146 v0 =
  let v1 = d_'42''45'isMonoid_3120 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v1)
           in coe
...
data T_IsRingWithoutAnnihilatingZero_3178
  = C_IsRingWithoutAnnihilatingZero'46'constructor_55017
      MAlonzo.Code.Algebra.Structures.T_IsAbelianGroup_980
      MAlonzo.Code.Algebra.Structures.T_IsMonoid_604
      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
du_identity'691'_3212 v0 =
  let v1 = d_'43''45'isAbelianGroup_3196 (coe v0)
   in coe
        ( let v2 = MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Algebra.Structures.du_identity'691'_646
...
du_unique'691''45''8315''185'_3256 v0 v1 v2 v3 =
  let v4 = d_'43''45'isAbelianGroup_3196 (coe v3)
   in coe
        ( coe
            MAlonzo.Code.Algebra.Structures.du_unique'691''45''8315''185'_968
            (coe v0)
...
du_isPartialEquivalence_3282 v0 =
  let v1 = d_'42''45'isMonoid_3198 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v1)
           in coe
...
du_zero'737'_3304 v0 v1 v2 v3 v4 =
  coe
    ...
    ( let v5 = d_'43''45'isAbelianGroup_3196 (coe v4)
       in coe
            ( let v6 = MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v5)
               in coe
                    ( let v7 =
                            MAlonzo.Code.Algebra.Structures.d_isMonoid_906 (coe v6)
                       in coe
                            ( let v8 =
                                    MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v7)
                               in coe
                                    ( coe
                                        MAlonzo.Code.Algebra.Structures.du_setoid_168
