...
data T_Semilattice_10
  = C_Semilattice'46'constructor_193
...
du_isPartialEquivalence_46 v0 =
  let v1 = d_isSemilattice_30 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_2538 (coe v1)
           in coe
                ( let v3 =
                        MAlonzo.Code.Algebra.Structures.d_isSemigroup_484 (coe v2)
                   in coe
                        ( let v4 = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v3)
                           in coe
                                ( coe
...
data T_MeetSemilattice_88
  = C_MeetSemilattice'46'constructor_1459
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_isPartialEquivalence_124 v0 =
  let v1 = d_isMeetSemilattice_108 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_2538 (coe v1)
           in coe
...
du_magma_150 v0 =
  let v1 = coe du_semilattice_144 (coe v0)
   in coe
        ( let v2 = coe du_band_66 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Algebra.Bundles.du_magma_524
...
data T_JoinSemilattice_160
  = C_JoinSemilattice'46'constructor_2621
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_isPartialEquivalence_196 v0 =
  let v1 = d_isJoinSemilattice_180 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_2538 (coe v1)
           in coe
...
du_magma_222 v0 =
  let v1 = coe du_semilattice_216 (coe v0)
   in coe
        ( let v2 = coe du_band_66 (coe v1)
           in coe
                ( coe
...
data T_BoundedSemilattice_232
  = C_BoundedSemilattice'46'constructor_3817
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_identity'691'_268 v0 =
  let v1 = d_isBoundedSemilattice_256 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Structures.d_isCommutativeMonoid_724
                  (coe v1)
...
du_isBand_272 v0 =
  let v1 = d_isBoundedSemilattice_256 (coe v0)
   in coe (coe MAlonzo.Code.Algebra.Structures.du_isBand_772 (coe v1))
  ...
  let v1 = d_isBoundedSemilattice_256 (coe v0)
   in coe
        ( let v2 =
           ...
           in coe
                ( let v3 =
                        MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v2)
                   in coe
                        ( let v4 =
                                MAlonzo.Code.Algebra.Structures.d_isSemigroup_614 (coe v3)
                           in coe
                                ( let v5 = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v4)
                                   in coe
                                        ( coe
                                            MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                                            ( coe
...
du_magma_316 v0 =
  let v1 = coe du_semilattice_310 (coe v0)
   in coe
        ( let v2 = coe du_band_66 (coe v1)
           in coe
                ( coe
...
data T_BoundedMeetSemilattice_326
  = C_BoundedMeetSemilattice'46'constructor_5247
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_assoc_354 ::
  ...
  AgdaAny
du_assoc_354 v0 =
  let v1 = d_isBoundedMeetSemilattice_350 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Algebra.Structures.d_assoc_450
            ( coe
...
du_idem_358 v0 =
  let v1 = d_isBoundedMeetSemilattice_350 (coe v0)
   in coe (coe MAlonzo.Code.Algebra.Structures.d_idem_726 (coe v1))
  ...
  let v1 = d_isBoundedMeetSemilattice_350 (coe v0)
   in coe
        ( let v2 =
           ...
           in coe
                ( let v3 =
                        MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_2538 (coe v2)
                   in coe
                        ( let v4 =
                                MAlonzo.Code.Algebra.Structures.d_isSemigroup_484 (coe v3)
                           in coe
                                ( let v5 = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v4)
                                   in coe
                                        ( coe
...
du_boundedSemilattice_394 v0 =
  coe
    C_BoundedSemilattice'46'constructor_3817
    (d__'8743'__346 (coe v0))
    (d_'8868'_348 (coe v0))
    (d_isBoundedMeetSemilattice_350 (coe v0))
...
du_band_398 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T_Band_536
du_band_398 v0 =
  let v1 = coe du_boundedSemilattice_394 (coe v0)
   in coe (coe du_band_66 (coe du_semilattice_310 (coe v1)))
...
du_magma_400 v0 =
  let v1 = coe du_boundedSemilattice_394 (coe v0)
   in coe
        ( let v2 = coe du_semilattice_310 (coe v1)
           in coe
                ( let v3 = coe du_band_66 (coe v2)
                   in coe
                        ( coe
                            MAlonzo.Code.Algebra.Bundles.du_magma_524
...
data T_BoundedJoinSemilattice_412
  = C_BoundedJoinSemilattice'46'constructor_6587
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_assoc_440 ::
  ...
  AgdaAny
du_assoc_440 v0 =
  let v1 = d_isBoundedJoinSemilattice_436 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Algebra.Structures.d_assoc_450
            ( coe
...
du_boundedSemilattice_480 v0 =
  coe
    C_BoundedSemilattice'46'constructor_3817
    (d__'8744'__432 (coe v0))
    (d_'8869'_434 (coe v0))
    (d_isBoundedJoinSemilattice_436 (coe v0))
...
du_band_484 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T_Band_536
du_band_484 v0 =
  let v1 = coe du_boundedSemilattice_480 (coe v0)
   in coe (coe du_band_66 (coe du_semilattice_310 (coe v1)))
...
data T_DistributiveLattice_582
  = C_DistributiveLattice'46'constructor_9531
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_isPartialEquivalence_616 v0 =
  let v1 = d_isDistributiveLattice_606 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Lattice.Structures.d_isLattice_2916
                  (coe v1)
...
du_'8743''45'rawMagma_672 v0 =
  let v1 = coe du_lattice_662 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Algebra.Lattice.Bundles.Raw.du_'8743''45'rawMagma_36
...
data T_BooleanAlgebra_680
  = C_BooleanAlgebra'46'constructor_11505
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_isPartialEquivalence_728 v0 =
  let v1 = d_isBooleanAlgebra_716 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Algebra.Lattice.Structures.d_isDistributiveLattice_3000
                  (coe v1)
...
du_rawLattice_796 v0 =
  let v1 = coe du_distributiveLattice_788 (coe v0)
   in coe (coe du_rawLattice_564 (coe du_lattice_662 (coe v1)))
...
du_setoid_798 v0 =
  let v1 = coe du_distributiveLattice_788 (coe v0)
   in coe (coe du_setoid_572 (coe du_lattice_662 (coe v1)))
...
du_'8743''45'rawMagma_800 v0 =
  let v1 = coe du_distributiveLattice_788 (coe v0)
   in coe
        ( let v2 = coe du_lattice_662 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Algebra.Lattice.Bundles.Raw.du_'8743''45'rawMagma_36
