...
d_'8804''45'isPartialOrder_2984 =
  coe
    ...
    (coe d_'8804''45'isPreorder_2982)
    erased
...
d_'8804''45'isTotalOrder_2986 =
  coe
    ...
    (coe d_'8804''45'isPartialOrder_2984)
    (coe d_'8804''45'total_2970)
...
d_'8804''45'isDecTotalOrder_2988 =
  coe
    ...
    (coe d_'8804''45'isTotalOrder_2986)
    (coe d__'8799'__2950)
...
d_'60''45'isStrictTotalOrder_3034 =
  coe
    ...
    (coe d_'60''45'isStrictPartialOrder_3032)
    (coe d_'60''45'cmp_3008)
...
d_'8744''45'isBand_3094 =
  coe
    ...
    (coe d_'8744''45'isSemigroup_3090)
    erased
...
d_'8744''45'isIdempotentCommutativeMonoid_3108 =
  coe
    ...
    (coe d_'8744''45'isCommutativeMonoid_3104)
    erased
...
d_'8743''45'isBand_3220 =
  coe
    MAlonzo.Code.Algebra.Structures.C_IsBand'46'constructor_10105
    (coe d_'8743''45'isSemigroup_3216)
    erased
...
d_'8743''45'isIdempotentCommutativeMonoid_3234 =
  coe
    MAlonzo.Code.Algebra.Structures.C_IsIdempotentCommutativeMonoid'46'constructor_16935
    (coe d_'8743''45'isCommutativeMonoid_3230)
    erased
...
d_'8744''45''8743''45'isCommutativeSemiring_3240 =
  coe
    ...
    (coe d_'8744''45''8743''45'isSemiring_3238)
    erased
...
d_'8743''45''8744''45'isCommutativeSemiring_3246 =
  coe
    MAlonzo.Code.Algebra.Structures.C_IsCommutativeSemiring'46'constructor_47309
    (coe d_'8743''45''8744''45'isSemiring_3244)
    erased
...
d_'8744''45''8743''45'isBooleanAlgebra_3258 =
  coe
    ...
    (coe d_'8744''45'inverse_3070)
    (coe d_'8743''45'inverse_3142)
    erased
  ...
  if coe v0
    then
      coe
        ...
        erased
        ( let v1 = coe MAlonzo.Code.Agda.Builtin.Unit.C_tt_8
           in coe (coe (\v2 -> v1))
        )
    else
      coe
      ...
      if coe v1
        then
          coe
            ...
            ( let v2 = coe MAlonzo.Code.Agda.Builtin.Unit.C_tt_8
               in coe (coe (\v3 -> v2))
            )
        else
          coe
