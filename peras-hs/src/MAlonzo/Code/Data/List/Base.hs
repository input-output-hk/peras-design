      ...
      let v4 =
            coe
              ...
              ( coe
                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
                  (coe v0)
                  (coe du_intersperse_72 (coe v0) (coe v3))
              )
       in coe
            ( case coe v3 of
                [] -> coe v1
      ...
      let v4 =
            coe
              ...
              ( coe
                  du__'43''43'__62
                  (coe v0)
                  (coe du_intercalate_86 (coe v0) (coe v3))
              )
       in coe
            ( case coe v3 of
                [] -> coe v2
...
du_cartesianProductWith_100 v0 v1 v2 =
  case coe v1 of
    ...
    (:) v3 v4 ->
      coe
        du__'43''43'__62
        (coe du_map_22 (coe v0 v3) (coe v2))
      ...
      case coe v2 of
        ...
        (:) v5 v6 ->
          coe
            ...
            ( coe
                v0
                (coe MAlonzo.Code.Data.These.Base.C_these_52 (coe v3) (coe v5))
            )
...
du_zipWith_134 v0 v1 v2 =
  let v3 = coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16
   in coe
        ( case coe v1 of
            (:) v4 v5 ->
              case coe v2 of
  ...
  case coe v1 of
    ...
    (:) v2 v3 ->
      coe
        ...
        (coe v0 v2)
        (coe du_unzipWith_196 (coe v0) (coe v3))
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_partitionSumsWith_206 v0 =
  coe
    ...
    ( coe
        MAlonzo.Code.Function.Base.du__'8728''8242'__216
        (coe MAlonzo.Code.Data.These.Base.du_fromSum_54)
        (coe v0)
    )
...
du_ap_276 v0 v1 =
  coe
    du_concatMap_272
    (coe (\v2 -> coe du_map_22 (coe v2) (coe v1)))
    (coe v0)
...
du_length_304 =
  coe
    du_foldr_242
    ( let v0 = \v0 -> addInt (coe (1 :: Integer)) (coe v0)
       in coe (coe (\v1 -> v0))
    )
    (coe (0 :: Integer))
  ...
  case coe v2 of
    [] ->
      coe
        ...
        (coe v2)
    (:) v3 v4 ->
      let v5 = coe du_scanr_382 (coe v0) (coe v1) (coe v4)
       in coe
            ( case coe v5 of
                [] -> coe v5
                (:) v6 v7 ->
...
data T_InitLast_550
  = C_'91''93'_554
  | C__'8759''691''8242'__560 [AgdaAny] AgdaAny
...
du_initLast_564 v0 =
  case coe v0 of
    [] -> coe C_'91''93'_554
    (:) v1 v2 ->
      let v3 = coe du_initLast_564 (coe v2)
       in coe
            ( case coe v3 of
                C_'91''93'_554 ->
                  coe
...
du_unsnoc_586 v0 =
  let v1 = coe du_initLast_564 (coe v0)
   in coe
        ( case coe v1 of
    ...
    (:) v2 v3 ->
      let v4 =
            MAlonzo.Code.Relation.Nullary.Decidable.Core.d_does_28
              (coe v0 v2)
       in coe
            ( let v5 = coe du_partition_772 (coe v0) (coe v3)
               in coe
                    ( if coe v4
                        then case coe v5 of
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v6 v7 ->
        ...
        (:) v4 v5 ->
          let v6 =
                MAlonzo.Code.Relation.Nullary.Decidable.Core.d_does_28
                  (coe v0 v2 v4)
           in coe
                ( let v7 = coe du_derun_954 (coe v0) (coe v3)
                   in coe
                        ( if coe v6
                            then coe v7
                            else
...
du__'8759''691''63'__1098 v0 v1 =
  coe
    MAlonzo.Code.Data.Maybe.Base.du_maybe'8242'_48
    (coe du__'8759''691'__540 (coe v0))
    v0
    v1
