                      ...
                      coe
                        ...
                        ( coe
                            ...
                            ( coe
                                ...
                                (coe (\v21 -> coe v16 v21 v11 v13 v9))
                                (coe v12)
                                (coe v19)
                            )
                        )
          ...
          case coe v1 of
            (:) v11 v12 ->
              coe
                MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.C__'8759'__62
                v7
                (coe du_map'8314'_394 (coe v10) (coe v12) (coe v8))
            _ -> MAlonzo.RTE.mazUnreachableError
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
          ...
          case coe v2 of
            MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.C__'8759'__62 v11 v12 ->
              coe
                MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.C__'8759'__62
                v11
                (coe du_map'8315'_416 (coe v4) (coe v6) (coe v12))
            _ -> MAlonzo.RTE.mazUnreachableError
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      let v2 = subInt (coe v1) (coe (1 :: Integer))
       in coe
            ( coe
                MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.C__'8759'__62
                v0
                (coe du_replicate'8314'_548 (coe v0) (coe v2))
            )
