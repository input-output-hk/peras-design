...
du_gmap'8315'_696 v0 v1 v2 =
  coe
    ...
    (coe v0)
    (coe v1)
    (coe du_map'8315'_682 (coe v1) (coe v2))
      ...
      case coe v1 of
        MAlonzo.Code.Data.List.Relation.Unary.All.C__'8759'__60 v6 v7 ->
          coe
            ...
            (coe (\v8 v9 -> v9))
            (coe du_'43''43''8315'_806 (coe v3) (coe v7))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_unsnoc'8314'_888 v0 v1 =
  let v2 =
        coe MAlonzo.Code.Data.List.Base.du_initLast_564 (coe v0)
   in coe
        ( case coe v2 of
...
du_partition'45'All_1534 v0 v1 =
  coe
    ...
    ( coe
        du_all'45'filter_1408
        ( coe
            MAlonzo.Code.Relation.Unary.Properties.du_'8705''63'_324
            (coe v0)
        )
        (coe v1)
    )
