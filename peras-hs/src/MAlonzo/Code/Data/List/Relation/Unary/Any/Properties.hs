...
du__'8855'__40 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
du__'8855'__40 =
  let v0 = coe MAlonzo.Code.Data.List.Effectful.du_monad_24
   in coe
        ( \v1 v2 ->
            coe
      ...
      case coe v1 of
        (:) v6 v7 ->
          coe
            ...
            (coe v0)
            (coe du_swap_226 (coe v0) (coe v7) (coe v5))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_map'8596'_760 v0 =
  coe
    MAlonzo.Code.Function.Bundles.du_mk'8596''8347''8242'_2364
    (coe du_map'8314'_710 (coe v0))
    (coe du_map'8315'_716 (coe v0))
      ...
      case coe v1 of
        ...
        MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54 v6 ->
          coe
            ...
            (coe MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54)
            (\v7 -> v7)
            (coe du_'43''43''8315'_848 (coe v3) (coe v6))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
       ...
       in coe
            ( case coe v7 of
                MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v8 ->
                  let v9 = coe du_map'8315'_716 (coe v3) (coe v8)
                   in coe
                        ( coe
                            MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                            ( coe
...
du_applyUpTo'8315'_1388 v0 =
  case coe v0 of
    ...
    MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54 v3 ->
      let v4 = coe du_applyUpTo'8315'_1388 (coe v3)
       in coe
            ( case coe v4 of
                MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v5 v6 ->
                  case coe v6 of
  ...
  let v2 = subInt (coe v0) (coe (1 :: Integer))
   in coe
        ( case coe v1 of
            ...
            MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54 v5 ->
              let v6 = coe du_applyDownFrom'8315'_1468 (coe v2) (coe v5)
               in coe
                    ( case coe v6 of
                        MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v7 v8 ->
                          case coe v8 of
    ...
    (:) v2 v3 ->
      let v4 =
       ...
       in coe
            ( case coe v4 of
                MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v5 ->
                  let v6 = coe du_reverseAcc'8315'_1996 (coe v3) (coe v5)
                   in coe
                        ( case coe v6 of
...
du_reverse'8315'_2068 v0 v1 =
  let v2 = coe du_reverseAcc'8315'_1996 (coe v0) (coe v1)
   in coe
        ( case coe v2 of
...
du_pure'8596'_2098 =
  coe
    MAlonzo.Code.Function.Bundles.du_mk'8596''8347''8242'_2364
    (coe du_pure'8314'_2080)
    (coe du_pure'8315'_2082)
