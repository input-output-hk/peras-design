...
du_length'45'mapMaybe_260 v0 v1 =
  case coe v1 of
    ...
    (:) v2 v3 ->
      let v4 = coe du_length'45'mapMaybe_260 (coe v0) (coe v3)
       in coe
            ( let v5 = coe v0 v2
               in coe
                    ( case coe v5 of
...
du_length'45'isMonoidHomomorphism_2982 =
  coe
    ...
    (coe du_length'45'isMagmaHomomorphism_2976)
    erased
      ...
      case coe v1 of
        ...
        MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54 v6 ->
          coe
            ...
            v2
            (coe du_'8712''8658''8739'product_4154 (coe v3) (coe v6))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_length'45'filter_5020 v0 v1 =
  case coe v1 of
    [] -> coe MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26
    (:) v2 v3 ->
      let v4 = coe du_length'45'filter_5020 (coe v0) (coe v3)
       in coe
            ( let v5 =
    ...
    (:) v3 v4 ->
      case coe v2 of
        ...
        MAlonzo.Code.Data.List.Relation.Unary.Any.C_there_54 v7 ->
          let v8 =
                coe du_filter'45'notAll_5082 (coe v0) (coe v4) (coe v7)
           in coe
                ( let v9 =
                        MAlonzo.Code.Relation.Nullary.Decidable.Core.d_does_28
                          (coe v0 v3)
  ...
  case coe v1 of
    ...
    (:) v2 v3 ->
      case coe v3 of
        ...
        (:) v4 v5 ->
          let v6 = coe du_length'45'derun_5376 (coe v0) (coe v3)
           in coe
                ( let v7 =
                        MAlonzo.Code.Relation.Nullary.Decidable.Core.d_does_28
                          (coe v0 v2 v4)
  ...
  case coe v1 of
    [] ->
      coe
        ...
        (coe MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26)
    (:) v2 v3 ->
      let v4 = coe du_length'45'partition_5544 (coe v0) (coe v3)
       in coe
            ( let v5 =
                    MAlonzo.Code.Relation.Nullary.Decidable.Core.d_does_28
                      (coe v0 v2)
...
du_'8759''691''45'injective_5776 v0 v1 =
  case coe v0 of
    ...
    (:) v2 v3 ->
      case coe v1 of
        (:) v4 v5 ->
          let v6 = coe du_'8759''45'injective_42
           in coe
                ( coe
                    seq
                    (coe v6)
