...
du__'8859'__210 =
  let v0 = coe du_monadPlus_34
   in coe
        ( let v1 = MAlonzo.Code.Effect.Monad.d_rawMonadZero_292 (coe v0)
           in coe
                ( let v2 = MAlonzo.Code.Effect.Monad.d_rawMonad_214 (coe v1)
                   in coe
                        ( \v3 v4 ->
                            coe
