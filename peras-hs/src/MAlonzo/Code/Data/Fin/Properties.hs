      ...
      case coe v1 of
        ...
        MAlonzo.Code.Data.Fin.Base.C_suc_16 v5 ->
          coe
            ...
            erased
            (coe du__'8799'__48 (coe v3) (coe v5))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
  ...
  case coe v0 of
    ...
    MAlonzo.Code.Data.Fin.Base.C_suc_16 v3 ->
      case coe v1 of
        ...
        MAlonzo.Code.Data.Fin.Base.C_suc_16 v5 ->
          let v6 = coe du_'60''45'cmp_422 (coe v3) (coe v5)
           in coe
                ( case coe v6 of
...
du_combine'45'surjective_1272 v0 v1 =
  let v2 =
        coe
          MAlonzo.Code.Data.Fin.Base.du_remQuot_208
          (coe v0)
          (coe v1)
   in coe
        ( case coe v2 of
       ...
       in coe
            ( coe
                ...
                ( coe
                    ...
                    (MAlonzo.Code.Data.Fin.Base.d__ℕ'45'ℕ__376 (coe v4) (coe v3))
                    v4
                    v0
                    ( coe
                        MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_step'45''8804'_308
...
du_'8846''8660''8707'_1722 =
  coe
    ...
    ( coe
        ...
        (coe du_'8707''45'here_1708)
        (coe du_'8707''45'there_1712)
    )
  ...
  case coe v0 of
    ...
    _ ->
      let v3 = subInt (coe v0) (coe (1 :: Integer))
       in coe
            ( let v4 = coe v1 (coe MAlonzo.Code.Data.Fin.Base.C_zero_12)
               in coe
                    ( let v5 = coe du_'8704''45'cons_1690
                       in coe
                            ( case coe v4 of
...
du_'172''8704''10230''8707''172''45'smallest_1874 v0 v1 =
  case coe v0 of
    ...
    _ ->
      let v2 = subInt (coe v0) (coe (1 :: Integer))
       in coe
            ( let v3 = coe v1 (coe MAlonzo.Code.Data.Fin.Base.C_zero_12)
               in coe
                    ( case coe v3 of
                  ...
                  ( coe
                      ( \v9 ->
                          coe
                            ...
                            (coe v2 (coe MAlonzo.Code.Data.Fin.Base.C_suc_16 v9))
                      )
                  )
           in coe
                ( case coe v9 of
       ...
       in coe
            ( coe
                ...
                ( coe
                    ...
                    (MAlonzo.Code.Effect.Applicative.d_rawFunctor_30 (coe v0))
                    erased
                    erased
                    (coe du_'8704''45'cons_1690)
                    (coe v2 (coe MAlonzo.Code.Data.Fin.Base.C_zero_12))
       ...
       in coe
            ( case coe v1 of
                MAlonzo.Code.Data.Nat.Base.C_s'8804's_34 v5 ->
                  coe
                    du_s'8826's_2250
                    (coe du_'60''8658''8826'_2256 (coe v2) (coe v5))
                _ -> MAlonzo.RTE.mazUnreachableError
            )
...
du_'8826''8658''60''8242'_2268 v0 v1 =
  coe
    ...
    (coe v0)
    (coe du_'8826''8658''60'_2262 (coe v1))
