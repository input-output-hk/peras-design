      ...
      case coe v2 of
        MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v4 ->
          coe
            ...
            ( coe
                v0
                (coe MAlonzo.Code.Data.These.Base.C_these_52 (coe v3) (coe v4))
            )
        MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18 ->
          coe
            MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
...
du_zipWith_116 v0 v1 v2 =
  let v3 = coe MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
   in coe
        ( case coe v1 of
            MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v4 ->
              case coe v2 of
...
du_thatM_132 =
  coe
    du_maybe'8242'_48
    (coe MAlonzo.Code.Data.These.Base.C_these_52)
