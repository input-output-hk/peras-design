...
du_strictPartialOrder_114 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.Key.du_strictPartialOrder_118
    (coe v0)
...
du_strictTotalOrder_116 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.Key.du_strictTotalOrder_202
    (coe v0)
...
d_toPair_156 ::
  MAlonzo.Code.Data.Tree.AVL.Value.T_K'38'__56 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_toPair_156 = coe MAlonzo.Code.Data.Tree.AVL.Value.d_toPair_80
...
du_join'691''8315'_594 v0 v1 v2 v3 v4 v5 =
  case coe v1 of
    0 -> case coe v4 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
    _ ->
      let v6 = subInt (coe v1) (coe (1 :: Integer))
       in coe
            ( case coe v4 of
                MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v7 v8 ->
                  case coe v7 of
...
du_headTail_648 v0 v1 =
  case coe v1 of
    C_node_208 v2 v3 v5 v6 v7 v8 ->
      let v9 =
            let v9 = subInt (coe v2) (coe (1 :: Integer))
             in coe
                  ( let v10 = coe du_headTail_648 (coe v9) (coe v6)
                     in coe
                          ( case coe v10 of
                        ...
                        case coe v2 of
                          _
                            | coe geqInt (coe v2) (coe (1 :: Integer)) ->
                                let v11 = subInt (coe v2) (coe (1 :: Integer))
                                 in coe
                                      ( let v12 = coe du_headTail_648 (coe v11) (coe v6)
                                         in coe
                                              ( case coe v12 of
                                                  MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v13 v14 ->
                                                    case coe v14 of
...
du_initLast_698 v0 v1 =
  case coe v1 of
    C_node_208 v2 v3 v5 v6 v7 v8 ->
      let v9 =
            let v9 = subInt (coe v3) (coe (1 :: Integer))
             in coe
                  ( let v10 = coe du_initLast_698 (coe v9) (coe v7)
                     in coe
                          ( case coe v10 of
                              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v11 v12 ->
                                case coe v12 of
                ...
                C_leaf_192 v10 ->
                  let v11 =
                        case coe v3 of
                          _
                            | coe geqInt (coe v3) (coe (1 :: Integer)) ->
                                let v11 = subInt (coe v3) (coe (1 :: Integer))
                                 in coe
                                      ( let v12 = coe du_initLast_698 (coe v11) (coe v7)
                                         in coe
                                              ( case coe v12 of
                                                  MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v13 v14 ->
                                                    case coe v14 of
...
du_join_754 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 =
  let v10 =
        let v10 = subInt (coe v5) (coe (1 :: Integer))
         in coe
              ( let v11 = coe du_headTail_648 (coe v10) (coe v8)
                 in coe
                      ( case coe v11 of
        ...
        ( case coe v8 of
            C_leaf_192 v11 ->
              let v12 =
                    case coe v5 of
                      _
                        | coe geqInt (coe v5) (coe (1 :: Integer)) ->
                            let v12 = subInt (coe v5) (coe (1 :: Integer))
                             in coe
                                  ( let v13 = coe du_headTail_648 (coe v12) (coe v8)
                                     in coe
                                          ( case coe v13 of
                                              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v14 v15 ->
                                                case coe v15 of
               ...
               in coe
                    ( case coe v9 of
                        ...
                        MAlonzo.Code.Data.Tree.AVL.Height.C_'8764''45'_42 ->
                          case coe v6 of
                            _
                              | coe geqInt (coe v6) (coe (1 :: Integer)) ->
                                  coe
                                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                    (coe MAlonzo.Code.Data.Fin.Base.C_zero_12)
                                    ( coe
  ...
  case coe v2 of
    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4 ->
      coe
        ...
        (coe C_leaf_192 (coe v3))
        (coe C_leaf_192 (coe v4))
        (coe MAlonzo.Code.Data.Tree.AVL.Height.C_'8764'0_38)
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_delete_936 v0 v1 v2 v3 v4 v5 v6 =
  case coe v5 of
    ...
    C_node_208 v7 v8 v10 v11 v12 v13 ->
      let v14 = subInt (coe v3) (coe (1 :: Integer))
       in coe
            ( case coe v10 of
  ...
  case coe v0 of
    ...
    C_node_208 v1 v2 v4 v5 v6 v7 ->
      coe
        ...
        ( coe
            MAlonzo.Code.Data.DifferenceList.du__'8759'__28
            v4
...
du_size_1164 =
  coe
    ...
    (coe MAlonzo.Code.Data.List.Base.du_length_304)
    (coe du_toList_1154)
