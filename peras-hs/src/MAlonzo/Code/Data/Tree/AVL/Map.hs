...
du_insertWith_204 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_insertWith_296
    (coe v0)
    ( coe
        MAlonzo.Code.Data.Tree.AVL.Value.C_MkValue_50
        (\v1 v2 -> let v3 = \v3 -> v3 in coe (\v4 -> v3))
...
du_member_214 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_member_350
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
...
du_initLast_218 v0 =
  coe
    ...
    (coe MAlonzo.Code.Data.Tree.AVL.du_initLast_370 (coe v0))
...
du_foldr_220 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_foldr_386
    (coe (\v1 -> coe v0 v1))
...
du_fromList_226 v0 =
  coe
    MAlonzo.Code.Function.Base.du__'8728''8242'__216
    ( coe
        MAlonzo.Code.Data.Tree.AVL.du_fromList_394
        (coe v0)
        (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    )
    ( coe
...
du_toList_228 =
  coe
    ...
    (coe MAlonzo.Code.Data.Tree.AVL.du_toList_396)
...
du_size_230 = coe MAlonzo.Code.Data.Tree.AVL.du_size_400
...
du_unionWith_232 v0 v1 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_unionWith_422
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    (coe (\v2 -> v1))
...
du_union_236 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_union_444
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
...
du_unionsWith_238 v0 v1 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_unionsWith_448
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    (coe (\v2 -> v1))
...
du_unions_242 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_unions_454
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
...
du_intersectionWith_244 v0 v1 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_intersectionWith_480
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    (coe (\v2 -> v1))
...
du_intersection_248 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_intersection_514
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
...
du_intersectionsWith_250 v0 v1 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_intersectionsWith_518
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
    (coe (\v2 -> v1))
...
du_intersections_254 v0 =
  coe
    MAlonzo.Code.Data.Tree.AVL.du_intersections_528
    (coe v0)
    (coe MAlonzo.Code.Data.Tree.AVL.Value.du_const_94)
