...
d__'42'H__8 ::
  ...
  MAlonzo.Code.Algebra.Solver.Ring.T_HNF_512
d__'42'H__8 =
  let v0 = MAlonzo.Code.Level.d_0ℓ_22
   in coe
        ( let v1 = MAlonzo.Code.Level.d_0ℓ_22
           in coe
                ( let v2 =
                        coe
                          MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_fromCommutativeSemiring_1412
                          ( coe
                              MAlonzo.Code.Data.Nat.Properties.d_'43''45''42''45'commutativeSemiring_3640
                          )
                   in coe
                        ( let v3 = MAlonzo.Code.Data.Nat.Properties.d__'8799'__2558
                           in coe
                                ( coe
...
d_sem_130 =
  let v0 =
   ...
   in coe (coe MAlonzo.Code.Algebra.Solver.Ring.du_sem_480 (coe v0))
