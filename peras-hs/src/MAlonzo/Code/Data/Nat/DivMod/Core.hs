  ...
  case coe v6 of
    MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26 ->
      coe
        ...
        (coe addInt (coe v1) (coe v5))
        (coe v3)
        (coe v5)
    MAlonzo.Code.Data.Nat.Base.C_s'8804's_34 v10 ->
      let v11 = subInt (coe v2) (coe (1 :: Integer))
       in coe
            ( let v12 = subInt (coe v3) (coe (1 :: Integer))
               in coe
                    ( let v13 =
                            seq
                              (coe v7)
                              ( let v13 =
                                      MAlonzo.Code.Data.Nat.Properties.d__'60''63'__2900
                                        (coe v4)
                                        (coe v2)
                                 in coe
                                      ( case coe v13 of
                       ...
                       in coe
                            ( case coe v4 of
                                0 -> case coe v5 of
                                  ...
                                  _ -> coe v13
                                _ ->
                                  let v14 = subInt (coe v4) (coe (1 :: Integer))
                                   in coe
                                        ( case coe v5 of
                                            0 ->
                                              coe
                                            ...
                                            _ ->
                                              let v15 = subInt (coe v5) (coe (1 :: Integer))
                                               in coe
                                                    ( case coe v7 of
