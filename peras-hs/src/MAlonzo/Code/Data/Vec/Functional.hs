...
du_uncons_64 v0 =
  coe
    ...
    (coe du_head_56 (coe v0))
    (coe du_tail_60 (coe v0))
    ...
    _ ->
      let v4 = subInt (coe v2) (coe (1 :: Integer))
       in coe
            ( coe
                v0
                (coe du_head_56 (coe v3))
                ( coe
                    du_foldr_176
                    (coe v0)
                    (coe v1)
                    (coe v4)
                    (coe du_tail_60 (coe v3))
                )
            )
      ...
      let v4 = subInt (coe v2) (coe (1 :: Integer))
       in coe
            ( coe
                du_foldl_194
                (coe v0)
                (coe v0 v1 (coe du_head_56 (coe v3)))
                (coe v4)
                (coe du_tail_60 (coe v3))
            )
...
du_drop_262 v0 v1 v2 =
  coe
    v1
    ( coe
        MAlonzo.Code.Data.Fin.Base.du__'8593''691'__84
        (coe v0)
        (coe v2)
    )
...
du_reverse_270 v0 v1 v2 =
  coe
    v1
    (MAlonzo.Code.Data.Fin.Base.d_opposite_388 (coe v0) (coe v2))
