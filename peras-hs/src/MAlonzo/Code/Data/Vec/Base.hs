      ...
      let v3 = subInt (coe v2) (coe (1 :: Integer))
       in coe
            ( coe
                C__'8759'__38
                v1
                (coe du_iterate_96 (coe v0) (coe v0 v1) (coe v3))
            )
      ...
      case coe v0 of
        C__'8759'__38 v6 v7 ->
          coe
            C__'8759'__38
            v6
            (coe du_insertAt_108 (coe v7) (coe v4) (coe v2))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      case coe v1 of
        ...
        MAlonzo.Code.Data.Fin.Base.C_suc_16 v7 ->
          coe
            C__'8759'__38
            v4
            (coe du_updateAt_134 (coe v5) (coe v7) (coe v2))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      case coe v2 of
        ...
        C__'8759'__38 v7 v8 ->
          coe
            ...
            ( coe
                v0
                (coe MAlonzo.Code.Data.These.Base.C_these_52 (coe v4) (coe v7))
            )
      ...
      case coe v1 of
        C__'8759'__38 v6 v7 ->
          coe
            C__'8759'__38
            (coe v3 v6)
            (coe du__'8859'__284 (coe v4) (coe v7))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      let v7 = subInt (coe v0) (coe (1 :: Integer))
       in coe
            ( coe
                ...
                v7
                v5
                (coe du_foldr_352 (coe v7) (coe v1) (coe v2) (coe v6))
            )
    _ -> MAlonzo.RTE.mazUnreachableError
      ...
      case coe v4 of
        ...
        C__'8759'__38 v6 v7 ->
          coe
            v0
            v3
            (coe du_foldr'8321'_398 (coe v0) (coe C__'8759'__38 v6 v7))
        _ -> MAlonzo.RTE.mazUnreachableError
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_replicate_460 v0 v1 =
  case coe v0 of
    ...
    _ ->
      let v2 = subInt (coe v0) (coe (1 :: Integer))
       in coe (coe C__'8759'__38 v1 (coe du_replicate_460 (coe v2) (coe v1)))
                  ...
                  case coe v2 of
                    C__'8759'__38 v8 v9 ->
                      coe
                        C__'8759'__38
                        v8
                        (coe du_truncate_582 (coe v3) (coe v6) (coe v9))
                    _ -> MAlonzo.RTE.mazUnreachableError
                _ -> MAlonzo.RTE.mazUnreachableError
            )
  ...
  case coe v0 of
    ...
    C__'8759'__38 v3 v4 ->
      coe
        C__'8759'__38
        v3
        (coe du__'8759''691'__622 (coe v4) (coe v1))
    _ -> MAlonzo.RTE.mazUnreachableError
...
du_reverse_632 =
  coe
    du_foldl_372
    (coe (\v0 v1 v2 -> coe C__'8759'__38 v2 v1))
    (coe C_'91''93'_32)
...
du__'691''43''43'__638 v0 v1 =
  coe
    du_foldl_372
    (coe (\v2 v3 v4 -> coe C__'8759'__38 v4 v3))
    (coe v1)
    (coe v0)
  ...
  case coe v1 of
    ...
    C__'8759'__38 v3 v4 ->
      coe
        ...
        ( coe
            du__'8859'__284
            (coe du_replicate_460 (coe v0) (coe C__'8759'__38))
            (coe v3)
        )
