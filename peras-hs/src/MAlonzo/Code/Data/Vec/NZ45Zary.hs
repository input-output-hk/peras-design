  ...
  case coe v2 of
    ...
    _ ->
      let v3 = subInt (coe v2) (coe (1 :: Integer))
       in coe
            ( coe
                MAlonzo.Code.Agda.Primitive.d__'8852'__30
                v0
  ...
  case coe v0 of
    ...
    _ ->
      let v1 = subInt (coe v0) (coe (1 :: Integer))
       in coe (coe (\v2 -> coe du_right'45'inverse_178 (coe v1)))
...
du_uncurry'45''8704''8319'_194 v0 =
  coe
    ...
    (coe du_'8658'_214 (coe v0))
    (coe du_'8656'_232 (coe v0))
...
du_uncurry'45''8707''8319'_248 v0 =
  coe
    MAlonzo.Code.Function.Bundles.du_mk'8660'_2296
    (coe du_'8658'_268 (coe v0))
    (coe du_'8656'_284 (coe v0))
            ...
            ( case coe v1 of
                MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4 ->
                  coe
                    ...
                    (coe (\v5 v6 -> v6))
                    (coe du_'8658'_268 (coe v2) (coe v4))
                _ -> MAlonzo.RTE.mazUnreachableError
            )
