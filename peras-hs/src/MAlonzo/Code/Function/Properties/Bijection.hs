        ...
        ( coe
            ( \v3 v4 v5 ->
                let v6 =
                 ...
                 in coe
                      ( let v7 =
                              MAlonzo.Code.Function.Structures.d_isInjection_246 (coe v6)
                         in coe
                              ( let v8 =
                                      MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v7)
                                 in coe
                                      ( let v9 =
                                              coe MAlonzo.Code.Function.Structures.du_setoid_66 (coe v8)
                                         in coe
                                              ( coe
                                                  ...
                                                  ( coe
                                                      MAlonzo.Code.Function.Bundles.d_to_934
                                                      v2
                                                      ( coe
                                                          MAlonzo.Code.Function.Bundles.du_to'8315'_920
                                                          (coe MAlonzo.Code.Function.Bundles.du_surjection_946 (coe v2))
                                          ...
                                          ( let v9 =
                                             ...
                                             in coe
                                                  ( coe
                                                      ...
                                                      v4
                                                      (coe MAlonzo.Code.Function.Bundles.d_to_934 v2 v3)
