...
du_to'45'from_486 v0 v1 v2 v3 v4 v5 =
  let v6 =
        coe
          MAlonzo.Code.Function.Bundles.du_isRightInverse_1904
          (coe v0)
          (coe v1)
          (coe v2)
   in coe
        ( let v7 =
                MAlonzo.Code.Function.Structures.d_isCongruent_420 (coe v6)
           in coe
                ( let v8 =
                        ...
                        ( coe
                            ...
                            ( coe
                                ...
                                ( let v9 =
                                   ...
                                   in coe
                                        ( let v10 =
                                                MAlonzo.Code.Function.Structures.d_isCongruent_420 (coe v9)
                                           in coe
                                                ( let v11 =
                                                        coe MAlonzo.Code.Function.Structures.du_setoid_66 (coe v10)
                                                   in coe
                                                        ( coe
