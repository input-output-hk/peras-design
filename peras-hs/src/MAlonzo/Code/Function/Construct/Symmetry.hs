...
du_injective_52 v0 v1 v2 v3 v4 v5 v6 v7 v8 =
  coe
    ...
    ( coe
        ...
        ( coe
            v5
            (coe du_f'8315''185'_48 (coe v1) (coe v6))
            (coe du_f'8315''185'_48 (coe v1) (coe v7))
            v8
        )
    )
    ( coe
    ...
    ( coe
        ...
        ( coe
            ...
            ( let v3 =
               ...
               in coe
                    ( let v4 =
                            MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v3)
                       in coe
                            ( coe
        ...
        ( coe
            ...
            ( coe
                ...
                ( coe
                    ...
                    ( coe
                        MAlonzo.Code.Function.Structures.d_isInjection_246
                        (coe v1)
                    )
                )
            )
    ...
    ( coe
        ( \v2 v3 v4 ->
            let v5 =
             ...
             in coe
                  ( let v6 =
                          MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v5)
                     in coe
                          ( let v7 =
                                  coe MAlonzo.Code.Function.Structures.du_setoid_40 (coe v6)
                             in coe
                                  ( coe
...
du_isInverse_536 v0 =
  coe
    ...
    ( coe
        du_isLeftInverse_390
        ( coe
            MAlonzo.Code.Function.Structures.du_isRightInverse_570
            (coe v0)
        )
    )
    ( coe
        ...
        ( coe
            ...
            ( coe
                MAlonzo.Code.Function.Structures.d_isLeftInverse_500
                (coe v0)
            )
        )
    )
...
du_bijection_714 v0 v1 v2 v3 =
  coe
    ...
    ( coe
        ...
        ( let v4 =
                coe
                  MAlonzo.Code.Function.Bundles.du_isBijection_960
                  (coe v0)
                  (coe v1)
                  (coe v2)
           in coe
                ( let v5 =
                        MAlonzo.Code.Function.Structures.d_isInjection_246 (coe v4)
                   in coe
                        ( let v6 =
                                MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v5)
                           in coe
                ...
                ( let v5 =
                   ...
                   in coe
                        ( let v6 =
                           ...
                           in coe
                                ( let v7 =
                                        coe MAlonzo.Code.Function.Structures.du_setoid_66 (coe v6)
                                   in coe
                                        ( coe
                                            MAlonzo.Code.Relation.Binary.Structures.d_sym_36
                                            ( coe
    ...
    ( coe
        ( \v2 v3 v4 ->
            let v5 =
             ...
             in coe
                  ( let v6 =
                          MAlonzo.Code.Function.Structures.d_isInjection_246 (coe v5)
                     in coe
                          ( let v7 =
                                  MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v6)
                             in coe
                                  ( let v8 =
                                          coe MAlonzo.Code.Function.Structures.du_setoid_40 (coe v7)
                                     in coe
                                          ( coe
                                              MAlonzo.Code.Relation.Binary.Structures.du_reflexive_40
                                              ( coe
