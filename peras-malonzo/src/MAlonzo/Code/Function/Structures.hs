...
data T_IsCongruent_22
  = C_IsCongruent'46'constructor_985
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
...
du_isPartialEquivalence_52 v0 =
  let v1 = coe du_setoid_40 (coe v0)
   in coe
        ( coe
...
du_isPartialEquivalence_78 v0 =
  let v1 = coe du_setoid_66 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
            ( coe
...
data T_IsInjection_92
  = C_IsInjection'46'constructor_3991
      T_IsCongruent_22
...
du_isEquivalence_120 v0 =
  let v1 = d_isCongruent_100 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
...
du_isPartialEquivalence_122 v0 =
  let v1 = d_isCongruent_100 (coe v0)
   in coe
        ( let v2 = coe du_setoid_40 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                    ( coe
...
du_isEquivalence_144 v0 =
  let v1 = d_isCongruent_100 (coe v0)
   in coe (coe d_isEquivalence'8322'_36 (coe v1))
...
du_isPartialEquivalence_146 v0 =
  let v1 = d_isCongruent_100 (coe v0)
   in coe
        ( let v2 = coe du_setoid_66 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                    ( coe
...
du_isEquivalence_190 v0 =
  let v1 = d_isCongruent_170 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
  ...
  coe
    ...
    ( \v2 v3 ->
        coe
          ...
          ( coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
              (d_isEquivalence'8321'_34 (coe d_isCongruent_170 (coe v0)))
              v2
          )
    )
...
data T_IsBijection_238
  = C_IsBijection'46'constructor_10103
      T_IsInjection_92
      (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
du_isEquivalence_270 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe
        ( let v2 = d_isCongruent_100 (coe v1)
           in coe (coe d_isEquivalence'8321'_34 (coe v2))
        )
...
du_isPartialEquivalence_272 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe
        ( let v2 = d_isCongruent_100 (coe v1)
           in coe
                ( let v3 = coe du_setoid_40 (coe v2)
                   in coe
                        ( coe
                            MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                            ( coe
...
du_setoid_280 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe (coe du_setoid_40 (coe d_isCongruent_100 (coe v1)))
...
du_isEquivalence_294 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe
        ( let v2 = d_isCongruent_100 (coe v1)
           in coe (coe d_isEquivalence'8322'_36 (coe v2))
        )
...
du_isPartialEquivalence_296 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe
        ( let v2 = d_isCongruent_100 (coe v1)
           in coe
                ( let v3 = coe du_setoid_66 (coe v2)
                   in coe
                        ( coe
                            MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                            ( coe
...
du_setoid_304 v0 =
  let v1 = d_isInjection_246 (coe v0)
   in coe (coe du_setoid_66 (coe d_isCongruent_100 (coe v1)))
...
data T_IsLeftInverse_322
  = C_IsLeftInverse'46'constructor_14351
      T_IsCongruent_22
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_356 v0 =
  let v1 = d_isCongruent_334 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
...
du_isEquivalence_442 v0 =
  let v1 = d_isCongruent_420 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
...
data T_IsInverse_490
  = C_IsInverse'46'constructor_22425
      T_IsLeftInverse_322
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_530 v0 =
  let v1 = d_isLeftInverse_500 (coe v0)
   in coe
        ( let v2 = d_isCongruent_334 (coe v1)
           in coe (coe d_isEquivalence'8321'_34 (coe v2))
        )
...
du_setoid_540 v0 =
  let v1 = d_isLeftInverse_500 (coe v0)
   in coe (coe du_setoid_40 (coe d_isCongruent_334 (coe v1)))
...
du_setoid_564 v0 =
  let v1 = d_isLeftInverse_500 (coe v0)
   in coe (coe du_setoid_66 (coe d_isCongruent_334 (coe v1)))
...
data T_IsBiEquivalence_584
  = C_IsBiEquivalence'46'constructor_27983
      T_IsCongruent_22
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isEquivalence'8321'_606 v0 =
  coe
    d_isEquivalence'8321'_34
    (coe d_to'45'isCongruent_598 (coe v0))
...
du_isEquivalence_620 v0 =
  let v1 = d_to'45'isCongruent_598 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
...
data T_IsBiInverse_666
  = C_IsBiInverse'46'constructor_32699
      T_IsCongruent_22
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isEquivalence'8321'_696 v0 =
  coe
    d_isEquivalence'8321'_34
    (coe d_to'45'isCongruent_684 (coe v0))
...
du_isEquivalence_710 v0 =
  let v1 = d_to'45'isCongruent_684 (coe v0)
   in coe (coe d_isEquivalence'8321'_34 (coe v1))
...
data T_IsSplitSurjection_752
  = C_IsSplitSurjection'46'constructor_35449
      (AgdaAny -> AgdaAny)
      T_IsLeftInverse_322
...
du_isEquivalence_790 v0 =
  let v1 = d_isLeftInverse_762 (coe v0)
   in coe
        ( let v2 = d_isCongruent_334 (coe v1)
           in coe (coe d_isEquivalence'8321'_34 (coe v2))
        )
