...
data T_ProtoMetric_16
  = C_ProtoMetric'46'constructor_967
      AgdaAny
...
du_refl_74 v0 =
  let v1 = d_isProtoMetric_58 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isPartialOrder_42
                  (coe v1)
...
data T_PreMetric_128
  = C_PreMetric'46'constructor_4317
      AgdaAny
      (AgdaAny -> AgdaAny -> AgdaAny)
...
du_refl_188 v0 =
  let v1 = d_isPreMetric_170 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isProtoMetric_110
                  (coe v1)
...
data T_QuasiSemiMetric_246
  = C_QuasiSemiMetric'46'constructor_8241
      AgdaAny
      (AgdaAny -> AgdaAny -> AgdaAny)
...
du_refl_310 v0 =
  let v1 = d_isQuasiSemiMetric_288 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isPreMetric_182
                  (coe v1)
...
data T_SemiMetric_372
  = C_SemiMetric'46'constructor_12485
      AgdaAny
      (AgdaAny -> AgdaAny -> AgdaAny)
...
du_refl_438 v0 =
  let v1 = d_isSemiMetric_414 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isQuasiSemiMetric_258
                  (coe v1)
...
du_protoMetric_492 v0 =
  let v1 = coe du_quasiSemiMetric_486 (coe v0)
   in coe (coe du_protoMetric_234 (coe du_preMetric_356 (coe v1)))

-- Function.Metric.Bundles.GeneralMetric
d_GeneralMetric_504 a0 a1 a2 a3 a4 = ()
data T_GeneralMetric_504
  = C_GeneralMetric'46'constructor_17019
      AgdaAny
      (AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny)
...
du_refl_576 v0 =
  let v1 = d_isGeneralMetric_550 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isSemiMetric_342
                  (coe v1)
...
du_preMetric_630 v0 =
  let v1 = coe du_semiMetric_626 (coe v0)
   in coe (coe du_preMetric_356 (coe du_quasiSemiMetric_486 (coe v1)))
...
du_protoMetric_632 v0 =
  let v1 = coe du_semiMetric_626 (coe v0)
   in coe
        ( let v2 = coe du_quasiSemiMetric_486 (coe v1)
           in coe (coe du_protoMetric_234 (coe du_preMetric_356 (coe v2)))
        )
