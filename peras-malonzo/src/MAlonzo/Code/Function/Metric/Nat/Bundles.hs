...
data T_ProtoMetric_12
  = C_ProtoMetric'46'constructor_193
...
du_refl_48 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_refl_48 v0 =
  let v1 = d_isProtoMetric_32 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isPartialOrder_42
                  (coe v1)
...
data T_PreMetric_96
  = C_PreMetric'46'constructor_1617
      (AgdaAny -> AgdaAny -> Integer)
...
du_refl_134 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_refl_134 v0 =
  let v1 = d_isPreMetric_116 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isProtoMetric_110
                  (coe v1)
...
data T_QuasiSemiMetric_186
  = C_QuasiSemiMetric'46'constructor_3231
      ( AgdaAny ->
        AgdaAny ->
        Integer
      )
...
du_refl_228 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_refl_228 v0 =
  let v1 = d_isQuasiSemiMetric_206 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isPreMetric_182
                  (coe v1)
...
data T_SemiMetric_284
  = C_SemiMetric'46'constructor_4955
      (AgdaAny -> AgdaAny -> Integer)
...
du_refl_328 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_refl_328 v0 =
  let v1 = d_isSemiMetric_304 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isQuasiSemiMetric_258
                  (coe v1)
...
du_protoMetric_382 v0 =
  let v1 = coe du_quasiSemiMetric_376 (coe v0)
   in coe (coe du_protoMetric_180 (coe du_preMetric_274 (coe v1)))

-- Function.Metric.Nat.Bundles.Metric
d_Metric_388 a0 a1 = ()
data T_Metric_388
  = C_Metric'46'constructor_6749
      (AgdaAny -> AgdaAny -> Integer)
...
du_preMetric_488 v0 =
  let v1 = coe du_semiMetric_484 (coe v0)
   in coe (coe du_preMetric_274 (coe du_quasiSemiMetric_376 (coe v1)))
...
du_protoMetric_490 v0 =
  let v1 = coe du_semiMetric_484 (coe v0)
   in coe
        ( let v2 = coe du_quasiSemiMetric_376 (coe v1)
           in coe (coe du_protoMetric_180 (coe du_preMetric_274 (coe v2)))
        )
...
data T_UltraMetric_498
  = C_UltraMetric'46'constructor_8443
      (AgdaAny -> AgdaAny -> Integer)
      MAlonzo.Code.Function.Metric.Structures.T_IsGeneralMetric_332
...
du_refl_544 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_refl_544 v0 =
  let v1 = d_isUltraMetric_518 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Metric.Structures.d_isSemiMetric_342
                  (coe v1)
...
du_preMetric_598 v0 =
  let v1 = coe du_semiMetric_594 (coe v0)
   in coe (coe du_preMetric_274 (coe du_quasiSemiMetric_376 (coe v1)))
