...
du_isEquivalence_220 v0 =
  let v1 =
        MAlonzo.Code.Function.Structures.d_isInjection_246 (coe v0)
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v1)
           in coe
                ( coe
...
du_isEquivalence_736 v0 v1 v2 =
  let v3 = coe du_isCongruent_724 (coe v0) (coe v1) (coe v2)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
            (coe v3)
...
data T_Injection_776
  = C_Injection'46'constructor_8673
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_804 v0 v1 v2 =
  let v3 = coe du_function_790 (coe v2)
   in coe
        ( let v4 = coe du_isCongruent_724 (coe v0) (coe v1) (coe v3)
           in coe
                ( coe
                    MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                    (coe v4)
...
data T_Surjection_846
  = C_Surjection'46'constructor_11189
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_874 v0 v1 v2 =
  let v3 = coe du_function_860 (coe v2)
   in coe
        ( let v4 = coe du_isCongruent_724 (coe v0) (coe v1) (coe v3)
           in coe
                ( coe
...
data T_Bijection_926
  = C_Bijection'46'constructor_15263
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
du_injection_944 v0 =
  coe
    C_Injection'46'constructor_8673
    (coe d_to_934 (coe v0))
    (coe d_cong_936 (coe v0))
    (coe du_injective_940 (coe v0))
...
du_strictlySurjective_956 v0 v1 v2 =
  let v3 = coe du_surjection_946 (coe v2)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.du_strictlySurjective_230
...
du_isEquivalence_972 v0 v1 v2 =
  let v3 = coe du_isBijection_960 (coe v0) (coe v1) (coe v2)
   in coe
        ( let v4 =
                MAlonzo.Code.Function.Structures.d_isInjection_246 (coe v3)
           in coe
                ( let v5 =
                        MAlonzo.Code.Function.Structures.d_isCongruent_100 (coe v4)
                   in coe
                        ( coe
                            MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                            (coe v5)
...
du_isEquivalence_1412 v0 =
  let v1 =
   ...
   in coe
        ( let v2 =
                MAlonzo.Code.Function.Structures.d_isCongruent_334 (coe v1)
           in coe
                ( coe
                    MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                    (coe v2)
...
du_isEquivalence_1478 v0 =
  let v1 =
        MAlonzo.Code.Function.Structures.d_isCongruent_334 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
            (coe v1)
...
du_isEquivalence_1542 v0 =
  let v1 =
        MAlonzo.Code.Function.Structures.d_isCongruent_420 (coe v0)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
            (coe v1)
...
data T_Equivalence_1714
  = C_Equivalence'46'constructor_25777
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_1746 v0 v1 v2 =
  let v3 = coe du_toFunction_1732 (coe v2)
   in coe
        ( let v4 = coe du_isCongruent_724 (coe v0) (coe v1) (coe v3)
           in coe
                ( coe
...
data T_LeftInverse_1792
  = C_LeftInverse'46'constructor_29743
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_1832 v0 v1 v2 =
  let v3 = coe du_isLeftInverse_1816 (coe v0) (coe v1) (coe v2)
   in coe
        ( let v4 =
                MAlonzo.Code.Function.Structures.d_isCongruent_334 (coe v3)
           in coe
                ( coe
                    MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                    (coe v4)
...
du_equivalence_1872 v0 =
  coe
    C_Equivalence'46'constructor_25777
    (coe d_to_1804 (coe v0))
    (coe d_from_1806 (coe v0))
...
data T_RightInverse_1880
  = C_RightInverse'46'constructor_34521
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isEquivalence_1918 v0 v1 v2 =
  let v3 = coe du_isRightInverse_1904 (coe v0) (coe v1) (coe v2)
   in coe
        ( let v4 =
                MAlonzo.Code.Function.Structures.d_isCongruent_420 (coe v3)
           in coe
                ( coe
                    MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                    (coe v4)
...
du_equivalence_1958 v0 =
  coe
    C_Equivalence'46'constructor_25777
    (coe d_to_1892 (coe v0))
    (coe d_from_1894 (coe v0))
    (coe d_to'45'cong_1896 (coe v0))
    (coe d_from'45'cong_1898 (coe v0))

-- Function.Bundles._.Inverse
d_Inverse_1960 a0 a1 a2 a3 a4 a5 = ()
data T_Inverse_1960
  = C_Inverse'46'constructor_38549
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_leftInverse_1986 v0 =
  coe
    C_LeftInverse'46'constructor_29743
    (coe d_to_1972 (coe v0))
    (coe d_from_1974 (coe v0))
    (coe d_to'45'cong_1976 (coe v0))
...
du_strictlyInverse'737'_1994 v0 v1 v2 =
  let v3 = coe du_leftInverse_1986 (coe v2)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.du_strictlyInverse'737'_396
...
du_strictlyInverse'691'_2000 v0 v1 v2 =
  let v3 = coe du_rightInverse_1988 (coe v2)
   in coe
        ( coe
            MAlonzo.Code.Function.Structures.du_strictlyInverse'691'_482
...
du_isEquivalence_2014 v0 v1 v2 =
  let v3 = coe du_isInverse_2002 (coe v0) (coe v1) (coe v2)
   in coe
        ( let v4 =
                MAlonzo.Code.Function.Structures.d_isLeftInverse_500 (coe v3)
           in coe
                ( let v5 =
                        MAlonzo.Code.Function.Structures.d_isCongruent_334 (coe v4)
                   in coe
                        ( coe
                            MAlonzo.Code.Function.Structures.d_isEquivalence'8321'_34
                            (coe v5)
...
data T_BiEquivalence_2054
  = C_BiEquivalence'46'constructor_44601
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
data T_BiInverse_2080
  = C_BiInverse'46'constructor_47317
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_biEquivalence_2118 v0 =
  coe
    C_BiEquivalence'46'constructor_44601
    (coe d_to_2098 (coe v0))
    (coe d_from'8321'_2100 (coe v0))
    (coe d_from'8322'_2102 (coe v0))
