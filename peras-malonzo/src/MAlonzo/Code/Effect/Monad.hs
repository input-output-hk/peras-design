...
du__'60''36'__40 ::
  T_RawMonad_24 -> () -> () -> AgdaAny -> AgdaAny -> AgdaAny
du__'60''36'__40 v0 =
  let v1 = d_rawApplicative_32 (coe v0)
   in coe
        ( \v2 v3 v4 v5 ->
            coe
...
data T_RawMonadZero_206
  = C_RawMonadZero'46'constructor_6879
      T_RawMonad_24
...
du__'60''36'__222 v0 =
  let v1 = d_rawMonad_214 (coe v0)
   in coe
        ( let v2 = d_rawApplicative_32 (coe v1)
           in coe
                ( \v3 v4 v5 v6 ->
                    coe
                      MAlonzo.Code.Effect.Functor.du__'60''36'__32
...
data T_RawMonadPlus_284
  = C_RawMonadPlus'46'constructor_8773
      T_RawMonadZero_206
...
du__'42''62'__298 v0 =
  let v1 = d_rawMonadZero_292 (coe v0)
   in coe
        ( let v2 = d_rawMonad_214 (coe v1)
           in coe
                ( \v3 v4 v5 v6 ->
                    coe
                      MAlonzo.Code.Effect.Applicative.du__'42''62'__52
...
du__'60''36'__300 v0 =
  let v1 = d_rawMonadZero_292 (coe v0)
   in coe
        ( let v2 = d_rawMonad_214 (coe v1)
           in coe
                ( let v3 = d_rawApplicative_32 (coe v2)
                   in coe
                        ( \v4 v5 v6 v7 ->
                            coe
                              MAlonzo.Code.Effect.Functor.du__'60''36'__32
...
du__'62''62'__318 v0 =
  let v1 = d_rawMonadZero_292 (coe v0)
   in coe (\v2 v3 -> coe du__'62''62'__70 (coe d_rawMonad_214 (coe v1)))
...
du_unless_348 v0 =
  let v1 = d_rawMonadZero_292 (coe v0)
   in coe (coe du_unless_96 (coe d_rawMonad_214 (coe v1)))
...
du_when_350 v0 =
  let v1 = d_rawMonadZero_292 (coe v0)
   in coe (coe du_when_90 (coe d_rawMonad_214 (coe v1)))
...
data T_RawMonadTd_376
  = C_RawMonadTd'46'constructor_10961
      (() -> AgdaAny -> AgdaAny)
      T_RawMonad_24
