...
data T_RawMonoid_38
  = C_RawMonoid'46'constructor_477
...
data T_RawNearSemiring_108
  = C_RawNearSemiring'46'constructor_1429
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
data T_RawSemiring_148
  = C_RawSemiring'46'constructor_2033
      (AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny)
      AgdaAny
      AgdaAny
...
du_rawMagma_186 v0 =
  let v1 = coe du_rawNearSemiring_178 (coe v0)
   in coe (coe du_rawMagma_60 (coe du_'43''45'rawMonoid_134 (coe v1)))
...
du_'43''45'rawMonoid_188 v0 =
  coe
    du_'43''45'rawMonoid_134
    (coe du_rawNearSemiring_178 (coe v0))
...
data T_RawRingWithoutOne_196
  = C_RawRingWithoutOne'46'constructor_2755
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_rawMagma_232 v0 =
  let v1 = coe du_'43''45'rawGroup_226 (coe v0)
   in coe (coe du_rawMagma_60 (coe du_rawMonoid_96 (coe v1)))
...
du_'42''45'rawMagma_282 v0 =
  let v1 = coe du_rawSemiring_276 (coe v0)
   in coe
...
du_rawMagma_286 v0 =
  let v1 = coe du_rawSemiring_276 (coe v0)
   in coe
        ( let v2 = coe du_rawNearSemiring_178 (coe v1)
           in coe (coe du_rawMagma_60 (coe du_'43''45'rawMonoid_134 (coe v2)))
        )
...
du_'43''45'rawMonoid_288 v0 =
  let v1 = coe du_rawSemiring_276 (coe v0)
   in coe
        ( coe
            du_'43''45'rawMonoid_134
            (coe du_rawNearSemiring_178 (coe v1))
        )
...
du_'43''45'rawGroup_294 v0 =
  coe
    du_'43''45'rawGroup_226
    (coe du_rawRingWithoutOne_290 (coe v0))

-- Algebra.Bundles.Raw.RawQuasigroup
d_RawQuasigroup_300 a0 a1 = ()
data T_RawQuasigroup_300
  = C_RawQuasigroup'46'constructor_4309
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_rawQuasigroup_370 v0 =
  coe
    C_RawQuasigroup'46'constructor_4309
    (d__'8729'__362 (coe v0))
    (d__'92''92'__364 (coe v0))
    (d__'47''47'__366 (coe v0))
...
du_'47''47''45'rawMagma_376 v0 =
  coe
    du_'47''47''45'rawMagma_330
    (coe du_rawQuasigroup_370 (coe v0))
...
data T_RawKleeneAlgebra_386
  = C_RawKleeneAlgebra'46'constructor_5681
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny
      )
...
du_'42''45'rawMagma_426 v0 =
  let v1 = coe du_rawSemiring_420 (coe v0)
   in coe
        (coe du_'42''45'rawMagma_142 (coe du_rawNearSemiring_178 (coe v1)))
