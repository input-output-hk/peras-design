...
data T_IsSemigroupMorphism_148
  = C_IsSemigroupMorphism'46'constructor_1081
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
...
data T_IsMonoidMorphism_306
  = C_IsMonoidMorphism'46'constructor_2137
      T_IsSemigroupMorphism_148
      AgdaAny
...
du_commutativeMonoid_550 v0 =
  coe
    MAlonzo.Code.Algebra.Bundles.du_commutativeMonoid_992
    (coe v0)
...
du_'8315''185''45'homo_950 v0 v1 v2 v3 v4 =
  coe
    ...
    ( coe
        v2
        (coe MAlonzo.Code.Algebra.Bundles.d__'8315''185'_1292 v0 v4)
    )
    (coe v2 v4)
    ( coe
            ...
            ( coe
                ...
                ( coe
                    ...
                    ( coe
                        ...
                        ( let v5 = MAlonzo.Code.Algebra.Bundles.d_isGroup_1294 (coe v1)
                           in coe
                                ( let v6 =
            ...
            ( coe
                ...
                ( coe
                    ...
                    ( let v5 =
                            let v5 =
                                  coe MAlonzo.Code.Algebra.Bundles.du_monoid_1354 (coe v0)
                             in coe (coe MAlonzo.Code.Algebra.Bundles.du_semigroup_802 (coe v5))
                       in coe
                            ( coe
                ...
                ( coe
                    MAlonzo.Code.Algebra.Bundles.d__'8729'__494
                    ( let v5 =
                            coe MAlonzo.Code.Algebra.Bundles.du_monoid_1354 (coe v1)
                       in coe (coe MAlonzo.Code.Algebra.Bundles.du_semigroup_802 (coe v5))
                    )
                    ( coe
                        v2
...
du_'42''45'monoid_1306 v0 =
  let v1 =
        coe MAlonzo.Code.Algebra.Bundles.du_semiring_3666 (coe v0)
   in coe
        ( coe
...
data T_IsRingMorphism_1636
  = C_IsRingMorphism'46'constructor_13935
      T_IsAbelianGroupMorphism_1232
      T_IsMonoidMorphism_306
