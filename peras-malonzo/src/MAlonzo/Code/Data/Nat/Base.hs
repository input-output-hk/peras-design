  ...
  case coe v0 of
    ...
    _ ->
      let v2 = subInt (coe v0) (coe (1 :: Integer))
       in coe (coe ltInt (coe v2) (coe v1))
...
d__'8852''8242'__214 v0 v1 =
  let v2 = ltInt (coe v0) (coe v1)
   in coe (if coe v2 then coe v1 else coe v0)
...
d__'8851''8242'__242 v0 v1 =
  let v2 = ltInt (coe v0) (coe v1)
   in coe (if coe v2 then coe v0 else coe v1)
  ...
  case coe v0 of
    ...
    _ ->
      let v1 = subInt (coe v0) (coe (2 :: Integer))
       in coe (coe d_parity_260 (coe v1))
  ...
  case coe v1 of
    ...
    _ ->
      let v2 = subInt (coe v1) (coe (1 :: Integer))
       in coe (coe mulInt (coe v0) (coe d__'94'__272 (coe v0) (coe v2)))
      ...
      let v2 = subInt (coe v0) (coe (1 :: Integer))
       in coe
            ( case coe v1 of
                ...
                _ ->
                  let v3 = subInt (coe v1) (coe (1 :: Integer))
                   in coe (coe d_'8739'_'45'_'8739'_280 (coe v2) (coe v3))
            )
  ...
  case coe v0 of
    ...
    _ ->
      let v1 = subInt (coe v0) (coe (1 :: Integer))
       in coe (coe mulInt (coe v0) (coe d__'33'_332 (coe v1)))
      ...
      let v2 = subInt (coe v0) (coe (1 :: Integer))
       in coe
            ( case coe v1 of
                ...
                _ ->
                  let v3 = subInt (coe v1) (coe (1 :: Integer))
                   in coe (coe d_compare_482 (coe v2) (coe v3))
            )
