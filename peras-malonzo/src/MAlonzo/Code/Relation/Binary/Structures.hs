...
data T_IsPartialEquivalence_16
  = C_IsPartialEquivalence'46'constructor_273
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
...
data T_IsEquivalence_26
  = C_IsEquivalence'46'constructor_743
      (AgdaAny -> AgdaAny)
...
data T_IsPreorder_70
  = C_IsPreorder'46'constructor_3993
      T_IsEquivalence_26
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      ( AgdaAny ->
        AgdaAny ->
...
du_isPartialEquivalence_160 v0 =
  let v1 = d_isPreorder_132 (coe v0)
   in coe
...
data T_IsPartialOrder_174
  = C_IsPartialOrder'46'constructor_9831
      T_IsPreorder_70
...
du_isPartialEquivalence_210 v0 =
  let v1 = d_isPreorder_182 (coe v0)
   in coe
        (coe du_isPartialEquivalence_42 (coe d_isEquivalence_80 (coe v1)))
...
du_refl_248 v0 =
  let v1 = d_isPartialOrder_234 (coe v0)
   in coe (coe du_refl_98 (coe d_isPreorder_182 (coe v1)))
...
du_isPartialEquivalence_276 v0 =
  let v1 = coe du_isDecEquivalence_268 (coe v0)
   in coe
...
data T_IsStrictPartialOrder_290
  = C_IsStrictPartialOrder'46'constructor_14011
      T_IsEquivalence_26
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
...
du_'60''45'resp'691''45''8776'_328 v0 v1 v2 v3 =
  coe
    ...
    (d_'60''45'resp'45''8776'_308 (coe v0))
    v1
    v2
    v3
...
du_isPartialEquivalence_370 v0 =
  let v1 = d_isStrictPartialOrder_346 (coe v0)
   in coe
...
du_isPartialEquivalence_390 v0 =
  let v1 = coe du_isDecEquivalence_382 (coe v0)
   in coe
        (coe du_isPartialEquivalence_42 (coe d_isEquivalence_50 (coe v1)))
...
data T_IsTotalOrder_404
  = C_IsTotalOrder'46'constructor_20499
      T_IsPartialOrder_174
      ( AgdaAny ->
        AgdaAny ->
        MAlonzo.Code.Data.Sum.Base.T__'8846'__30
...
du_refl_424 v0 =
  let v1 = d_isPartialOrder_412 (coe v0)
   in coe (coe du_refl_98 (coe d_isPreorder_182 (coe v1)))
...
du_isPartialEquivalence_444 v0 =
  let v1 = d_isPartialOrder_412 (coe v0)
   in coe
        ( let v2 = d_isPreorder_182 (coe v1)
           in coe
...
data T_IsDecTotalOrder_460
  = C_IsDecTotalOrder'46'constructor_22635
      T_IsTotalOrder_404
      ( AgdaAny ->
        AgdaAny ->
        MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
...
du_refl_488 v0 =
  let v1 = d_isTotalOrder_470 (coe v0)
   in coe
        ( let v2 = d_isPartialOrder_412 (coe v1)
           in coe (coe du_refl_98 (coe d_isPreorder_182 (coe v2)))
        )
...
du_isPartialEquivalence_520 v0 =
  let v1 = coe du_isDecEquivalence_512 (coe v0)
   in coe
        (coe du_isPartialEquivalence_42 (coe d_isEquivalence_50 (coe v1)))
...
data T_IsStrictTotalOrder_534
  = C_IsStrictTotalOrder'46'constructor_24885
      T_IsStrictPartialOrder_290
      ( AgdaAny ->
        AgdaAny ->
...
du_isPartialEquivalence_578 v0 =
  let v1 = coe du_isDecEquivalence_570 (coe v0)
   in coe
        (coe du_isPartialEquivalence_42 (coe d_isEquivalence_50 (coe v1)))
...
data T_IsDenseLinearOrder_594
  = C_IsDenseLinearOrder'46'constructor_28059
      T_IsStrictTotalOrder_534
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
...
du_'60''45'resp'691''45''8776'_614 v0 =
  let v1 = d_isStrictTotalOrder_602 (coe v0)
   in coe
        ( coe
            du_'60''45'resp'691''45''8776'_328
...
du__'8799'__636 v0 =
  let v1 = d_isStrictTotalOrder_602 (coe v0)
   in coe (coe du__'8799'__562 (coe v1))
...
du_isPartialEquivalence_642 v0 =
  let v1 = d_isStrictTotalOrder_602 (coe v0)
   in coe
        ( let v2 = coe du_isDecEquivalence_570 (coe v1)
           in coe
...
data T_IsApartnessRelation_656
  = C_IsApartnessRelation'46'constructor_30149
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
