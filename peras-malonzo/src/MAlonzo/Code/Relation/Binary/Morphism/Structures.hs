...
newtype T_IsRelHomomorphism_42
  = C_IsRelHomomorphism'46'constructor_587
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
...
data T_IsOrderHomomorphism_138
  = C_IsOrderHomomorphism'46'constructor_5407
      ( AgdaAny ->
        AgdaAny ->
        AgdaAny ->
        AgdaAny
...
data T_IsOrderMonomorphism_182
  = C_IsOrderMonomorphism'46'constructor_9041
      T_IsOrderHomomorphism_138
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
      (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du_isRelHomomorphism_210 v0 =
  coe
    du_isRelHomomorphism_162
    (coe d_isOrderHomomorphism_200 (coe v0))
...
data T_IsOrderIsomorphism_238
  = C_IsOrderIsomorphism'46'constructor_14101
      T_IsOrderMonomorphism_182
      (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_cong_262 v0 =
  coe
    ...
    ( coe
        d_isOrderHomomorphism_200
        (coe d_isOrderMonomorphism_254 (coe v0))
    )
...
du_isRelHomomorphism_268 v0 =
  let v1 = d_isOrderMonomorphism_254 (coe v0)
   in coe
        ( coe
            du_isRelHomomorphism_162
            (coe d_isOrderHomomorphism_200 (coe v1))
        )
