document.addEventListener('DOMContentLoaded', () => {
  ...
  function startSimulation(step) {
    ...
    [uiDuration, uiParties, uiU, uiA, uiR, uiK, uiL, uiTau, uiB, uiCommittee, uiDelta, uiAlpha, uiDelay, uiSeed].forEach(ui => ui.disabled = true)
  ...
  uiStop.addEventListener('click', () => {
    [uiDuration, uiParties, uiU, uiA, uiR, uiK, uiL, uiTau, uiB, uiCommittee, uiDelta, uiAlpha, uiDelay, uiSeed].forEach(ui => ui.disabled = false)
  ...
  function handleMessage(msg) {
    ...
    switch (msg.tag) {
      ...
      case "CastVote":
        ...
        break;
      case "SelectedBlock":
        selectedBlock = msg.block;
        // Nothing to draw.
        break;
      case "NoBlockSelected":
        // Nothing to draw.
        break;
      case "ForgingLogic":
        {
      ...
      case "VotingLogic":
        ...
        if (!(msg.vr1a && msg.vr1b || msg.vr2a && msg.vr2b)) {
          const blockId = mkBlockId(selectedBlock);
