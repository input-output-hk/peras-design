  ...
  let
    commandOptions =
      Command
        ...
        <*> (O.optional . O.strOption) (O.long "trace-file" <> O.metavar "FILE" <> O.help "Path to output text file for simulation trace.")
        <*> (O.optional . O.strOption) (O.long "result-file" <> O.metavar "FILE" <> O.help "Path to output JSON file for simulation results.")
        <*> (O.optional . O.strOption) (O.long "network-dot-file" <> O.metavar "FILE" <> O.help "Path to output GraphViz .dot file of network visualizaton.")
        <*> (O.optional . O.strOption) (O.long "network-png-file" <> O.metavar "FILE" <> O.help "Path to output PNG file of network visualizaton. Requires `GraphViz` executable.")
        <*> (O.optional . O.strOption) (O.long "chain-dot-file" <> O.metavar "FILE" <> O.help "Path to output GraphViz .dot file of chain visualizaton.")
        <*> (O.optional . O.strOption) (O.long "chain-png-file" <> O.metavar "FILE" <> O.help "Path to output PNG file of chain visualizaton. Requires `GraphViz` executable.")
   in
     O.info
       (
         O.helper
